...
import { ShieldCheck, Truck, Search, ShoppingBag, Settings, LogOut } from 'lucide-react';

export default function Navbar({ activeRole, setActiveRole, onOpenSettings }) {
  return (
